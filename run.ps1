# ============================================================
# LangGraph AIOps Platform - Windows launcher
# ============================================================
# Startup order:
...
if ($Stop) {
    Write-Host "[stop] stopping langgraph-aiops-platform services..." -ForegroundColor Yellow
...
& $Python -m uvicorn backend.main:app `
    ...
    --port $AppPort `
    --reload `
    --reload-dir "$ProjectRoot\backend"
