"""\u544a\u8b66\u6a21\u62df\u5668 \u2014 \u6a21\u62df Prometheus Alertmanager \u53d1 webhook \u7ed9 langgraph-aiops-platform.
...
\u5de5\u4f5c\u539f\u7406:
    ...
    2. langgraph-aiops-platform /api/v1/webhook/alertmanager \u63a5\u6536\u540e\u540e\u53f0\u542f\u52a8 AIOps \u8bca\u65ad
...
def fire_alert(base_url: str, scenario_key: str) -> None:
    ...
    try:
        ...
        print(f"\u2717 \u8bf7\u6c42\u5931\u8d25: {e}")
        print(f"  \u8bf7\u786e\u8ba4 langgraph-aiops-platform \u5728\u8fd0\u884c: {base_url}")
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="\u6a21\u62df Alertmanager \u53d1 webhook \u7ed9 langgraph-aiops-platform",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=(
            "\u53ef\u7528\u573a\u666f: " + ", ".join(SCENARIOS.keys()) + "\n\n"
            "\u6f14\u793a\u6d41\u7a0b:\n"
            "  1. \u542f langgraph-aiops-platform (.\\run.ps1)\n"
    ...
    ap.add_argument(
        ...
        help="langgraph-aiops-platform base URL (\u9ed8\u8ba4 http://localhost:9900)",
    )
    ap.add_argument(
        "--scenario",
