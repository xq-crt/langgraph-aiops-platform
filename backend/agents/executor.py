...
设计要点:
  - 默认走 backend.runtime.tool_runner.run_parallel_agent (§3 cc-haha 借鉴):
...
from backend.runtime.permissions import (
    PermissionDecision,
    PermissionMode,
    parse_permission_mode,
)
from backend.runtime.agent_harness import get_agent_harness
from backend.runtime.tool_filter import filter_tools_for_skill
...
from backend.agents.state import PlanExecuteState
from backend.agents.stream_sink import emit as emit_stream, set_step
