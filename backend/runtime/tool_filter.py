...
from backend.tools.lazy_mcp_tools import expose_tools_with_lazy_mcp
from backend.tools.meta import TOOL_META, get_meta
...
def _is_tool_allowed_by_guardrails(tool_name: str) -> bool:
    ...
    替代品: backend.runtime.permissions.evaluate_permission()
