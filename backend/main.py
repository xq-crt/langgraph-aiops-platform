...
启动方式:
  开发: uvicorn backend.main:app --reload
  生产: uvicorn backend.main:app --workers 4
"""
...
from backend.api.v1 import aiops, chat, dashboard, documents, health, skills, webhook
from backend.config import settings
from backend.core.mcp_client import mcp_client_manager
from backend.core.milvus import milvus_manager
